...
export default function infoCardAbout() {
    return (
                            /* w-full bg-[#00335C] py-10 flex flex-col justify-center items-center  */
        <section className="pt-[5rem] pb-[5rem] flex flex-col items-center justify-center w-[100vw]  gap-[50px] bg-[#00335C] ">
