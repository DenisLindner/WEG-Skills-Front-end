                ...
                <Card className="w-full max-w-[500px] bg-white border-none p-6 sm:p-10 shadow-2xl rounded-2xl">
                    ...
                    <CardContent className="flex flex-col gap-6 sm:gap-8">
                        ...
                        <div className="group relative flex flex-col pt-6 w-full sm:w-[85%] mx-auto">
                            ...
                            {/* Esqueceu a senha debaixo da senha com um leve espaçamento */}
                            <div className="mt-3.5 flex justify-start pl-1">
                                <Link
                                    href="/recovery_password"
                                    className="text-sm font-normal text-[#005294] hover:underline cursor-pointer transition-colors"
                                >
                                    Esqueceu a senha?
                                </Link>
                            </div>
